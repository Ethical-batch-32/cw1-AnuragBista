...
<?php if (isset($_SESSION['ticket'])){?>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="dashboard.php"><h1><span>T</span>ech<span>D</span>eals<span>O</span>nline<i>.com</i></h1></a>
        </li>
        <?php } 
        else { ?>
        <a class="nav-link active" aria-current="page" href="homepage.php"><h1><span>T</span>ech<span>D</span>eals<span>O</span>nline<i>.com</i></h1></a>
        <?php } ?>
